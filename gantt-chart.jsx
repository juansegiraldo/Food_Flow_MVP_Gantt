...
// Cronograma: tech y legal desde cronogramav2; brand y alliance sin cambios
const initialActivities = [
  // Arquitectura Tecnológica (tech) — solo desde nuevo JSON
  { id: 4, name: "Desarrollo App Frontend(Pedidos + Notif Cocina)", cat: "tech", start: 1, dur: 4 },
  { id: 5, name: "Integración pagos Conekta", cat: "tech", start: 5, dur: 2 },
  { id: 6, name: "Primer test end-to-end", cat: "tech", start: 7, dur: 1 },
  { id: 7, name: "Adaptación look & feel definitivo", cat: "tech", start: 8, dur: 3 },
  { id: 8, name: "Push notifications (Firebase+OneSignal)", cat: "tech", start: 8, dur: 2 },
  { id: 11, name: "App Dashboard Frontend", cat: "tech", start: 12, dur: 3 },
  { id: 12, name: "Integración SAP Ciere Caja", cat: "tech", start: 8, dur: 3 },
  { id: 13, name: "QA integral y go-live", cat: "tech", start: 20, dur: 4 },
  { id: 49, name: "Desarrollo app Backend(Pedidos + Notif Cocina)", cat: "tech", start: 1, dur: 4 },
  { id: 50, name: "App Dashboard Backend", cat: "tech", start: 12, dur: 3 },
  { id: 51, name: "App Driver stock Frontend", cat: "tech", start: 16, dur: 3 },
  { id: 52, name: "App Driver stock Backend", cat: "tech", start: 16, dur: 3 },
  { id: 53, name: "Arquitectura técnica/Modelo datos/CI CD", cat: "tech", start: 0, dur: 1 },
  { id: 54, name: "QA integral", cat: "tech", start: 11, dur: 1 },
  { id: 55, name: "QA Dashboard", cat: "tech", start: 15, dur: 1 },
  { id: 56, name: "QA Stock", cat: "tech", start: 19, dur: 1 },
  // Branding & MKT — sin cambios (actual)
  ...
  { id: 20, name: "Diseño + instalación vinilado", cat: "brand", start: 9, dur: 4 },
  { id: 21, name: "Lanzamiento de RRSS", cat: "brand", start: 10, dur: 2 },
  ...
  // Logística y Marco Legal (legal) — solo desde nuevo JSON
  ...
  // Alianzas Estratégicas — sin cambios (actual)
  ...
  { id: 57, name: "Maduración de Alianzas adicionales", cat: "alliance", start: 12, dur: 8 },
];
